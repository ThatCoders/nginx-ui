  ...
  <AForm layout="vertical">
    <AAlert
      ...
      :description="$gettext('Logrotate, by default, is enabled in most mainstream '
        + 'Linux distributions for users who install Water NG on the host machine, '
        + 'so you don\'t need to modify the parameters on this page. '
        + 'For users who install Water NG using Docker containers, you can manually enable this option. '
        + 'The crontab task scheduler of Water NG will execute the logrotate command at the interval you set in minutes.')"
      type="info"
    />
